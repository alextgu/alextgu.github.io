  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start w-full">
        {/* Left: Text Content */}
        <div className="space-y-6 sm:space-y-12 pl-4 sm:pl-6 md:pl-20 lg:pl-20">
          <div>
            {/* Header */}
            <h1 className="text-4xl sm:text-[48px] custom:text-[60px] xl:text-[68px] font-normal text-gray-400 dark:text-zinc-500 leading-[5rem]">
              Hi, I'm{' '}
              <span
            ...
            {/* Typing subtitle */}
            <p className="text-xl sm:text-[20px] custom:text-[22px] xl:text-2xl font-light text-gray-700 dark:text-zinc-300 mt-2 tracking-tight leading-relaxed sm:leading-normal">
          ...
          {/* Body text */}
          <p className="text-2xl sm:text-[27px] custom:text-[30px] xl:text-[32px] font-normal text-gray-400 dark:text-zinc-500 leading-relaxed custom:leading-snug">
            I love playing{' '}
            <Link to="/hobbies">
