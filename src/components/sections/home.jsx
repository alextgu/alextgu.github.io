...
function Home() {
    ...
    <section id="home" className="min-h-screen pt-20 md:pt-24">
      <div className="grid md:grid-cols-2 gap-12 items-start w-full">
        ...
        <div className="space-y-12 pl-12 md:pl-20 lg:pl-20">
          <h1 className="text-3xl sm:text-4xl lg:text-[31px] font-normal text-gray-400 dark:text-zinc-500 leading-loose">
            Hi, I'm{' '}
            <span
  ...
  <span className="relative inline-block group">
    ...
    <span className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-1 opacity-0 w-max px-2 py-1 text-sm text-gray-900 bg-white border border-gray-300 rounded-md pointer-events-none
      shadow-md transition-opacity duration-300 delay-400 group-hover:opacity-100">
...
<p className="text-3xl sm:text-4xl lg:text-[32px] font-normal text-gray-400 dark:text-zinc-500 leading-loose">
  ...
  <span className="absolute top-full left-1/2 transform -translate-x-1/2 mt-1 opacity-0 w-max px-2 py-1 text-sm text-gray-900 bg-white border border-gray-300 rounded-md pointer-events-none
    shadow-md transition-opacity duration-300 delay-400 group-hover:opacity-100">
    I need friends
  </span>
</span>
